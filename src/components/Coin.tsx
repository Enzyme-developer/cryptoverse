...
const Coin = ({ coin } : Props) => {
  ...
  return (
    <tr className='h-[80px] border-b overflow-hidden min-h-screen'>
      <td onClick={saveCoin} className='cursor-pointer' >{!save ? <AiOutlineStar /> : <AiFillStar />}</td>
      <td className='px-4'>{coin.market_cap_rank}</td>
